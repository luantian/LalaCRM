...
async function main() {
  ...
  // 创建按钮权限
  const buttons = [
    { key: 'system:backup:create', label: '创建备份', perm: 'system:backup:create' },
    { key: 'system:backup:download', label: '下载备份', perm: 'system:backup:download' },
    { key: 'system:backup:delete', label: '删除备份', perm: 'system:backup:delete' },
    { key: 'system:backup:restore', label: '恢复备份', perm: 'system:backup:restore' },
    { key: 'system:backup:config', label: '备份配置', perm: 'system:backup:config' }
  ];
