...
export const exportQuotationsExcel = (params?: any) => api.get('/quotations/export/excel', { params, responseType: 'blob' })
...
export const exportQuotationsCsv = (params?: any) => api.get('/quotations/export/csv', { params, responseType: 'blob' })
// 下载报价单导入模板(与导入格式对齐,附填写说明)
export const downloadQuotationImportTemplate = () => api.get('/quotations/import-template', { responseType: 'blob' })
